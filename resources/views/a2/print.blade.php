            ...
            <td colspan="4">
                <table width="100%" style="table-layout: fixed; border-collapse: collapse;">
                    ...
                    <tr class="no-border">
                        ...
                        <td class="no-border" colspan="2">{{ (($register->nom_pajak2 !== null || $register->nom_pajak2 <> 0) && $register->jpajak_2 == 'PAD')? '' : ((($register->nom_pajak2 !== null || $register->nom_pajak2 <> 0) && $register->jpajak_2 !== null)?$dpp2:'') }}</td>
